...
🛠 Tech Stack
Python |spaCy| PyPDF2 | Regular Expressions (Regex)

🚀 Use Case
Ideal for ATS systems, HR automation, and resume screening tools where quick and reliable resume data extraction is required.
